...
if(isset($_GET["id"])){
      ...
      <div class="item" id="'.$post["category_num"].'-'.$post["id"].'">
            <div class="header-item">
                <ul>
                    ...
                    <li class="category-name-of-item" onclick="images_link()" style="background : var(--active-option);">
                      <span>صور</span>
                      <span>&nbsp;</span>
                    </li>
            ...
            <div class="item-content " style="opacity:1">
                <div class="item-image " onclick="show_full_image(this)">
          ...
          <ul class="footer-item">
            ...
            <li onclick="download_image(this)"><span class="material-icons icon icon-footer">save_alt</span></li>
  ...
  if(!is_dir("../../../../public_html/archives/images/".$added_year."/".$added_month."/".$added_day)){
    if(!is_dir("../../../../public_html/archives/images/")){
      mkdir("../../../../public_html/archives/images/");
      chmod("../../../../public_html/archives/images/",0777);
    }

    if(!is_dir("../../../../public_html/archives/images/".$added_year)){
      mkdir("../../../../public_html/archives/images/".$added_year);
      chmod("../../../../public_html/archives/images/".$added_year,0777);
    }

    if(!is_dir("../../../../public_html/archives/images/".$added_year."/".$added_month)){
      mkdir("../../../../public_html/archives/images/".$added_year."/".$added_month);
      chmod("../../../../public_html/archives/images/".$added_year."/".$added_month,0777);
    }

    if(!is_dir("../../../../public_html/archives/images/".$added_year."/".$added_month."/".$added_day)){
      mkdir("../../../../public_html/archives/images/".$added_year."/".$added_month."/".$added_day);
      chmod("../../../../public_html/archives/images/".$added_year."/".$added_month."/".$added_day,0777);
    }

  }
  $file = fopen("../../../../public_html/archives/images/".$added_year."/".$added_month."/".$added_day."/{$post_id}.html","w");
  chmod("../../../../public_html/archives/images/".$added_year."/".$added_month."/".$added_day."/{$post_id}.html",0777);
