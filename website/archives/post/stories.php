...
$category_table = "ahke_category.stories";
...
if(isset($_GET["id"])){
  ...
  if($get_post->rowCount()){
    ...
    if($post["post_title"] != null){
      $post_title = '<div class="item-title">
                        <span class="material-icons icon item-title-circle">brightness_1</span>
                        <h1 id="item-title" style="font-size:16px;">'.$post["post_title"].'</h1>
                     </div>';
    }else{
      $post_title = '';
    }
        ...
        <div class="item" id="'.$post["category_num"].'-'.$post["id"].'">
              <div class="header-item">
                  <ul>
                      ...
                      <li class="category-name-of-item" onclick="stories_link()" style="background : var(--active-option);">
                        <span>قصص</span>
                        <span>&nbsp;</span>
                      </li>
    ...
    if(!is_dir("../../../../public_html/archives/stories/".$added_year."/".$added_month."/".$added_day)){
      if(!is_dir("../../../../public_html/archives/stories/")){
        mkdir("../../../../public_html/archives/stories/");
        chmod("../../../../public_html/archives/stories/",0777);
      }

      if(!is_dir("../../../../public_html/archives/stories/".$added_year)){
        mkdir("../../../../public_html/archives/stories/".$added_year);
        chmod("../../../../public_html/archives/stories/".$added_year,0777);
      }

      if(!is_dir("../../../../public_html/archives/stories/".$added_year."/".$added_month)){
        mkdir("../../../../public_html/archives/stories/".$added_year."/".$added_month);
        chmod("../../../../public_html/archives/stories/".$added_year."/".$added_month,0777);
      }

      if(!is_dir("../../../../public_html/archives/stories/".$added_year."/".$added_month."/".$added_day)){
        mkdir("../../../../public_html/archives/stories/".$added_year."/".$added_month."/".$added_day);
        chmod("../../../../public_html/archives/stories/".$added_year."/".$added_month."/".$added_day,0777);
      }

    }
    $file = fopen("../../../../public_html/archives/stories/".$added_year."/".$added_month."/".$added_day."/{$post_id}.html","w");
    chmod("../../../../public_html/archives/stories/".$added_year."/".$added_month."/".$added_day."/{$post_id}.html",0777);
