...
$category_table = "ahke_category.from_book";
...
if(isset($_GET["id"])){
  ...
  if($get_post->rowCount()){
    ...
    if($post["image_path"] != null){
       ...
       $image = '<div class="item-image " onclick="show_full_image(this)">
                    <img src="'.$api_host.'/media/images/category/'.$post["image_path"].'" loading="lazy">
                 </div>';
    }
    if($post["post_text"] != null){
       $text = '<div class="item-text" style="font-size:16px;" onclick="show_full_text(this,1,'.$post["id"].')">'.natural_text($post["post_text"]).'</div>';
    }
    $post_dom = '
        <div class="item" id="'.$post["category_num"].'-'.$post["id"].'">
              <div class="header-item">
                  <ul>
                      ...
                      <li class="category-name-of-item" onclick="from_book_link()" style="background : var(--active-option);">
                        <span>من كتاب</span>
                        <span>&nbsp;</span>
                      </li>
              ...
              <div class="item-content " style="opacity:1">
                 <div class="item-title">
                    <span class="material-icons icon item-title-circle">brightness_1</span>
                    <h1 onclick="search_book(\''.natural_text($post["post_title"]).'\')" style="font-size:16px;cursor: pointer;">من كتاب | <span id="item-title">'.$post["post_title"].'</span>
                    </h1> 
                  </div>
                  '.$image.'
                  '.$text.'
    ...
    if(!is_dir("../../../../public_html/archives/from_book/".$added_year."/".$added_month."/".$added_day)){
      if(!is_dir("../../../../public_html/archives/from_book/")){
        mkdir("../../../../public_html/archives/from_book/");
        chmod("../../../../public_html/archives/from_book/",0777);
      }

      if(!is_dir("../../../../public_html/archives/from_book/".$added_year)){
        mkdir("../../../../public_html/archives/from_book/".$added_year);
        chmod("../../../../public_html/archives/from_book/".$added_year,0777);
      }

      if(!is_dir("../../../../public_html/archives/from_book/".$added_year."/".$added_month)){
        mkdir("../../../../public_html/archives/from_book/".$added_year."/".$added_month);
        chmod("../../../../public_html/archives/from_book/".$added_year."/".$added_month,0777);
      }

      if(!is_dir("../../../../public_html/archives/from_book/".$added_year."/".$added_month."/".$added_day)){
        mkdir("../../../../public_html/archives/from_book/".$added_year."/".$added_month."/".$added_day);
        chmod("../../../../public_html/archives/from_book/".$added_year."/".$added_month."/".$added_day,0777);
      }

    }
    $file = fopen("../../../../public_html/archives/from_book/".$added_year."/".$added_month."/".$added_day."/{$post_id}.html","w");
    chmod("../../../../public_html/archives/from_book/".$added_year."/".$added_month."/".$added_day."/{$post_id}.html",0777);
