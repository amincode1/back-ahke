...
if(isset($_GET["id"])){
  ...
  if($get_post->rowCount()){
        ...
        <div class="item" id="'.$post["category_num"].'-'.$post["id"].'">
              <div class="header-item">
                  <ul>
                      ...
                      <li class="category-name-of-item" onclick="do_you_know_link()" style="background : var(--active-option);">
                        <span>هل تعلم</span>
                        <span>&nbsp;</span>
                      </li>
    ...
    if(!is_dir("../../../../public_html/archives/do_you_know/".$added_year."/".$added_month."/".$added_day)){
      if(!is_dir("../../../../public_html/archives/do_you_know/")){
        mkdir("../../../../public_html/archives/do_you_know/");
        chmod("../../../../public_html/archives/do_you_know/",0777);
      }

      if(!is_dir("../../../../public_html/archives/do_you_know/".$added_year)){
        mkdir("../../../../public_html/archives/do_you_know/".$added_year);
        chmod("../../../../public_html/archives/do_you_know/".$added_year,0777);
      }

      if(!is_dir("../../../../public_html/archives/do_you_know/".$added_year."/".$added_month)){
        mkdir("../../../../public_html/archives/do_you_know/".$added_year."/".$added_month);
        chmod("../../../../public_html/archives/do_you_know/".$added_year."/".$added_month,0777);
      }

      if(!is_dir("../../../../public_html/archives/do_you_know/".$added_year."/".$added_month."/".$added_day)){
        mkdir("../../../../public_html/archives/do_you_know/".$added_year."/".$added_month."/".$added_day);
        chmod("../../../../public_html/archives/do_you_know/".$added_year."/".$added_month."/".$added_day,0777);
      }

    }
    $file = fopen("../../../../public_html/archives/do_you_know/".$added_year."/".$added_month."/".$added_day."/{$post_id}.html","w");
    chmod("../../../../public_html/archives/do_you_know/".$added_year."/".$added_month."/".$added_day."/{$post_id}.html",0777);
